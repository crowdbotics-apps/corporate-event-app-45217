"""
Django settings for corporate_event_app_45217 project.
...
ROOT_URLCONF = 'corporate_event_app_45217.urls'
...
WSGI_APPLICATION = 'corporate_event_app_45217.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "corporate_event_app_45217 API",
    "DESCRIPTION": "API documentation for corporate_event_app_45217 App",
    "VERSION": "v1",
}
